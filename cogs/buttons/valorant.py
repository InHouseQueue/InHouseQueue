...
class SpectateButton(ui.View):
    ...
    @ui.button(label="Spectate Red", style=ButtonStyle.red, custom_id="valorant-specred")
    async def spec_red(self, button, inter):
        await self.process_button(button, inter)

    @ui.button(label="Spectate Blue", style=ButtonStyle.blurple, custom_id="valorant-specblue")
...
class ReadyButton(ui.View):
    ...
    @ui.button(label="Ready Up!", style=ButtonStyle.green, custom_id="valorant-readyup")
    ...
    @ui.button(label="Duo", style=ButtonStyle.blurple, custom_id="valorant-readyup:duo")
...
class QueueButtons(ui.View):
    ...
    @ui.button(label="Leave Queue", style=ButtonStyle.red, custom_id="valorant-queue:signoff")
    ...
    @ui.button(label="Switch Team", style=ButtonStyle.blurple, custom_id="valorant-queue:switchteam")
    ...
    @ui.button(label="Duo", style=ButtonStyle.blurple, custom_id="valorant-queue:duo")
