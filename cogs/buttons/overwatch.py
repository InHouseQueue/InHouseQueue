...
class SpectateButton(ui.View):
    ...
    @ui.button(label="Spectate Red", style=ButtonStyle.red, custom_id="overwatch-specred")
    async def spec_red(self, button, inter):
        await self.process_button(button, inter)

    @ui.button(label="Spectate Blue", style=ButtonStyle.blurple, custom_id="overwatch-specblue")
...
class ReadyButton(ui.View):
    ...
    @ui.button(label="Ready Up!", style=ButtonStyle.green, custom_id="overwatch-readyup")
    ...
    @ui.button(label="Duo", style=ButtonStyle.blurple, custom_id="overwatch-readyup:duo")
...
class QueueButtons(ui.View):
    ...
    @ui.button(label="Tank", style=ButtonStyle.green, custom_id="overwatch-queue:first")
    async def first_button(self, button, inter):
        await self.process_button(button, inter)

    @ui.button(label="DPS", style=ButtonStyle.green, custom_id="overwatch-queue:second")
    async def second_button(self, button, inter):
        await self.process_button(button, inter)

    @ui.button(label="Support", style=ButtonStyle.green, custom_id="overwatch-queue:third")
    async def third_button(self, button, inter):
        await self.process_button(button, inter)

    @ui.button(label="Leave Queue", style=ButtonStyle.red, custom_id="overwatch-queue:signoff")
    ...
    @ui.button(label="Switch Team", style=ButtonStyle.blurple, custom_id="overwatch-queue:switchteam")
    ...
    @ui.button(label="Duo", style=ButtonStyle.blurple, custom_id="overwatch-queue:duo")
